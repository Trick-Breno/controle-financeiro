        ...
        <div className="px-6">
            <form onSubmit={(e) => handleCriar(e)}>
                <div className="flex flex-col gap-2">
                    <h3 className=" font-semibold text-lg text-gray-800 my-2">Criar Carteira</h3>
                    <div className="flex gap-2"><div className="flex flex-col items-baseline gap-1">
                        <label className="">Nome</label>
                        <input type="text" name="nome" required className="w-full p-1 border  border-gray-600  rounded-md"/>
                    </div>
                    <div className="flex flex-col items-baseline gap-1">
                        <label className="">Saldo </label>
                        <input type="number" step="0.01" name="saldo_inicial" className="w-28 p-1 border  border-gray-600  rounded-md"/>
                    </div></div>
